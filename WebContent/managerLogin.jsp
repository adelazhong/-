        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1 login_wrap">
                <div class="panel panel-default panel-red">
                    <div class="row">
                        <div class="col-md-6">
                            <h3 class="login_h3">輔仁大學場協管理系統</h3>
                            <p class="login_p">登入：請於方框中輸入<span class="login_span">LDAP</span>帳號、密碼登入 
                        </div>
                        <div class="col-md-6">
                            <div class="panel-body">
                                <form class="form-horizontal"  action="/web/WEB_ManagerLoginAction" method="post">
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-md-2 control-label login_label">帳號</label><br><br>
                                        <div class="col-md-12">
                                            <input type="text" name="manager.managerAccount" class="form-control login_input" id="inputEmail3" placeholder="LDAP帳號">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputPassword3" class="col-md-2 control-label login_label">密碼</label><br><br>
                                        <div class="col-md-12">
                                            <input type="password" name="manager.managerPassword" class="form-control login_input" id="inputPassword3">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-10">
